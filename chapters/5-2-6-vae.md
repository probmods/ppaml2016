...
<canvas class='mnist-draw' width='224' height='224'></canvas>
<div id="downsampled"></div>
<div id="mnist-result"><b>Classification</b>: <span></span></div>
<button id="mnist-classify">Classify</button> <button id="mnist-clear">Clear</button>
